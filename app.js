...
app.set('view engine','ejs')//Set EJS template enging
app.use('/home',homeRouter)//http://localhost:3000/user
app.use('/about',aboutRouter)//http://localhost:3000/about
app.use('/contact',contactRouter)//http://localhost:3000/contact
